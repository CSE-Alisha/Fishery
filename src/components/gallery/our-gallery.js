    ...
    <React.Fragment>
      <div className={classes.gallery} id="FreshWaterFish">
        ...
        <p className={classes.content}>
          Welcome to the "We 4 Fishery Gallery". Explore the breathtaking
          moments, successful catches and the natural beauty of our fishing
          adventures captured through the lens of our clients and our team.
        </p>
